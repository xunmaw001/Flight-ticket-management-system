		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">乘机地点：</label>
						<div class="layui-input-block">
							<input v-model="detail.chengjididian" type="text" :readonly="ro.chengjididian" name="chengjididian" id="chengjididian" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">飞行时长：</label>
						<div class="layui-input-block">
							<input v-model="detail.feixingshizhang" type="text" :readonly="ro.feixingshizhang" name="feixingshizhang" id="feixingshizhang" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('hangbanjipiao/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('hangbanjipiao' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
