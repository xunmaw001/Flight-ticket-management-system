	...
	<body>
				...
				<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"-14px -14px 0px 14px #A4ECAC","margin":"50px","borderColor":"rgba(10, 88, 162, 1)","borderRadius":"0","borderWidth":"4px","background":"transparent url(http://codegen.caihongy.cn/20220304/b814ed2d1f844c76a4ba390cedf5e359.png) no-repeat top","borderStyle":"solid"}'>
				  <div class="box" style='width:100%'>
				    ...
				    <div class="title" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"-75px 0 40px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(247, 247, 247, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0","fontSize":"16px","borderStyle":"solid"}'>
				      <span>Recommend</span><span>航班机票推荐</span>
				    </div>
				    ...
				    <div class="list">
				      <div v-for="(item,index) in hangbanjipiaoRecommend" :key="index" @click="jump('../hangbanjipiao/detail.jsp?id='+item.id)" class="list-item" :class="5=='3'?'list-item3':5=='5'?'list-item5':''">
				        <div class="list-item-body animation-box" :style='{"padding":"10px 10px 0","boxShadow":"0px 3px 6px rgba(0, 0, 0, 0.16)","margin":"0 0 10px 0","borderColor":"rgba(112, 112, 112, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
							<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"170px","borderStyle":"solid","height":"240px"}' :src="item.fengmiantupian?baseurl+item.fengmiantupian.split(',')[0]:''" alt="" />
							<div class="line1" v-if='true' :style='{"isshow":true,"padding":"16px 0","margin":"5px 0 0 0","backgroundColor":"rgba(164, 236, 172, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"90px 90px 0 0","textAlign":"center","fontSize":"14px"}' class="name">{{item.hangban}}</div>
				        </div>
				      </div>
				    </div>
				    <div class="clear"></div>
				    <div style="text-align: center;">
			    <button @click="jump('../hangbanjipiao/list.jsp')" style="display: block;cursor: pointer;" type="button" :style='{"padding":"0 50px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"4px auto 0","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"90px 90px 0 0","borderWidth":"2px","width":"auto","fontSize":"14px","borderStyle":"solid","height":"50px"}'>查看更多<i v-if="true" :style='{"isshow":true,"padding":"0 0 0 1px","fontSize":"14px","color":"rgba(0, 0, 0, 1)"}' class="layui-icon layui-icon-next"></i></el-button>
				    </div>
		...
		<script>
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
                ...
                // 获取推荐信息
      				var autoSortUrl = "hangbanjipiao/autoSort";
				http.request(autoSortUrl, 'get', {
					page: 1,
					limit: 5 * 2 
				}, function(res) {
					vue.hangbanjipiaoRecommend = res.data.list
					let flag = 1;
					let options = {"navigation":{"nextEl":".swiper-button-next","prevEl":".swiper-button-prev"},"slidesPerView":5,"loop":true,"spaceBetween":20,"autoplay":{"delay":3000,"disableOnInteraction":false}}
					options.pagination = {el:'null'}
					...
					if(flag == 3) {
						vue.$nextTick(() => {
								new Swiper ('#recommendhangbanjipiao', options)
						})
					}
					...
					if(flag == 5) {
						vue.$nextTick(() => {
							var swiper = new Swiper('#recommend-five-swiperhangbanjipiao', {
								loop: true,
								speed: 500,
