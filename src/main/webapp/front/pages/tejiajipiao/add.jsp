				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.jipiaobianhao" type="text" :readonly="ro.jipiaobianhao" name="jipiaobianhao" id="jipiaobianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input type="text" name="qifeishijian" id="qifeishijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">到达时间：</label>
						<div class="layui-input-block">
							<input type="text" name="daodashijian" id="daodashijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">起飞地点：</label>
						<div class="layui-input-block">
							<input v-model="detail.qifeididian" type="text" :readonly="ro.qifeididian" name="qifeididian" id="qifeididian" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">到达地点：</label>
						<div class="layui-input-block">
							<input v-model="detail.daodadidian" type="text" :readonly="ro.daodadidian" name="daodadidian" id="daodadidian" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.tejia" type="text" :readonly="ro.tejia" name="tejia" id="tejia" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">机票详情：</label>
						<div class="layui-input-block">
							<textarea name="jipiaoxiangqing" id="jipiaoxiangqing">请输入机票详情</textarea>
						</div>
					</div>
			...
			var vue = new Vue({
				...
				data: {
					...
					ro:{
                                        ...
                                        tejia : false,
                                        fabushijian : false,
                                        jipiaoxiangqing : false,
					},
                    detail: {
                        jipiaobianhao: genTradeNo(),
                        hangkonggongsi: '',
                        hangban: '',
                        fengmiantupian: '',
                        qifeishijian: '',
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
                                ...
                                jquery('#qifeishijian').val(getCurDateTime());
				laydate.render({
					elem: '#qifeishijian',
					type: 'datetime'
				});
                                jquery('#daodashijian').val(getCurDateTime());
				laydate.render({
					elem: '#daodashijian',
					type: 'datetime'
				});
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='qifeishijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.qifeishijian = true;
                                                jquery('#qifeishijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='daodashijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.daodashijian = true;
                                                jquery('#daodashijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='qifeididian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.qifeididian = true;
                                                continue;
                                        }
                                        if(o=='daodadidian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.daodadidian = true;
                                                continue;
                                        }
                                        if(o=='leixing'){
                                                vue.detail[o] = obj[o];
                                        ...
                                        if(o=='jipiaoxiangqing'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.jipiaoxiangqing = true;
                                                continue;
                                        }
					}
				}
				...
				form.on('submit(*)', function(data) {
					...
					var jipiaoxiangqing = tinymce.get('#jipiaoxiangqing').getContent()
					data.jipiaoxiangqing = jipiaoxiangqing;
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('tejiajipiao/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('tejiajipiao' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
